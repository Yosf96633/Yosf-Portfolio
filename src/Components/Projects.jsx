...
const Projects = () => {
  ...
  return (
    <div
      id="projects"
      className="min-h-[90vh] max-md:min-h-[70vh] py-16 w-full bg-black text-[#EEEEEE] flex flex-col space-y-8 items-center border-b-[0.5px] selection:bg-[#AA14F0] selection:text-black border-[#BC8CF2]"
    >
      ...
      <section className="projects-section">
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
            ...
            >
              ...
              <div className="tech-stack flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech, i) => (
                  <span
                    key={i}
                    className="tech-badge bg-purple-500 text-white px-3 py-1 rounded-full"
                  >
                    {tech}
                  </span>
                ))}
